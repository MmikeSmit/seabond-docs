...
| 标签类型 | 示例 | 含义 |
| --- | --- | --- |
| 账户规模 | 鲸鱼、鲨鱼、海豚、小鱼 | 按当前持仓规模区分钱包体量。 |
| 币种偏好 | 主流币、山寨币、TradFi、综合 | 判断钱包主要交易哪些类型的标的。 |
| 方向偏好 | 偏多、偏空、均衡型 | 判断钱包更常做多、做空，还是多空相对均衡。 |
| 交易周期 | 超短线、短线、中长线 | 判断钱包更偏短频交易，还是更长周期持仓。 |
| 表现标记 | 胜率狂人、稳定增值、赚钱机器 | 对胜率、稳定性或交易活跃度表现较突出的钱包做提示。 |

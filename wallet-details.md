...
详情页也会展示钱包画像标签，帮助你快速理解这个钱包的交易风格。

- **账户规模**：区分钱包当前持仓体量，例如鲸鱼、鲨鱼、海豚、小鱼。
- **币种偏好**：判断它更常交易主流币、山寨币、TradFi 标的，还是多个类型都有。
- **方向偏好**：判断它更偏多、偏空，还是多空相对均衡。
- **交易周期**：判断它偏超短线、短线，还是中长线。
- **表现标记**：提示胜率、稳定性或交易活跃度较突出的特征。
